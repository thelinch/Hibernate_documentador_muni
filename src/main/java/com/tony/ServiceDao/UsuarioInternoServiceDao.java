...
public interface UsuarioInternoServiceDao {
    ...
    boolean Registrar_operacion_documento_usuario_interno(Usuario_interno usuarioInterno, Documento documento, String Accion);

    boolean Enviar_area_documento(Documento documento, Usuario_interno user_interno);
    ...
    void get_area_find_by_tupa(String nameTupa, TextAutoCompleter llenar_area);

    List<Usuario_interno> get_usuario_interno_find_by_nombre_area(String Area_Nombre, TextAutoCompleter llenar_trabajadores);
